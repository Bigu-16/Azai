  ...
  return (
    <nav className="fixed top-0 w-full z-50 glass h-16 md:h-20 border-b border-white/10 flex items-center justify-between px-4 md:px-[8%]">
      <div className="flex items-center gap-4">
        <Link to="/" className="flex items-center gap-1.5 md:gap-2.5 text-sm md:text-xl font-extrabold tracking-[2px] uppercase">
          <img src="/logo.png" alt="AZYAB Logo" className="h-8 w-8 md:h-13 md:w-13 object-contain" style={{ marginTop: '-4px' }} />
